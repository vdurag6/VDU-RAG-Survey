...
| [Deep Learning based Visually Rich Document Content Understanding: A Survey](https://arxiv.org/abs/2408.01287) | Artificial Intelligence Re | conf. | 2026 | [link](https://arxiv.org/abs/2408.01287) |
| Large Language Models in Document Intelligence: A Comprehensive Survey, Recent Advances, Challenges, and Future Trends | ACM TOIS | journal | 2026 | – |
...
| Paper | Venue | Type | Year | Channel | Link |
|---|:-:|:-:|:-:|:-:|:-:|
| [TexTAR: Textual Attribute Recognition in Multi-domain and Multi-lingual Document Images](https://arxiv.org/abs/2509.13151) | preprint | preprint | 2025 | Typography | [link](https://arxiv.org/abs/2509.13151) |
...
| [Enhancing RAG System Performance Through Semantic Layout Chunking](https://doi.org/10.1007/978-981-95-4969-6_3) | Int. Conf. Artificial Inte | conf. | 2026 | [link](https://doi.org/10.1007/978-981-95-4969-6_3) |
...
| [Defining the Problem: The Impact of OCR Quality on Retrieval-Augmented Generation Performance and Strategies for Improvement](https://doi.org/10.1016/j.ipm.2025.104368) | Information Processing \&  | conf. | 2026 | [link](https://doi.org/10.1016/j.ipm.2025.104368) |
...
| [BBox-DocVQA: Bounding-Box Grounded Document VQA](https://arxiv.org/abs/2511.15090) | preprint | preprint | 2025 | [link](https://arxiv.org/abs/2511.15090) |
...
<!-- VENUES:START -->
| Venue | Type | Field | Papers | Add |
|---|:-:|:-:|:-:|:-:|
| CVPR | conference | Vision | **16** | [➕](../../issues/new?template=add-paper.yml) |
| ICCV | conference | Vision | **6** | [➕](../../issues/new?template=add-paper.yml) |
| ECCV | conference | Vision | **4** | [➕](../../issues/new?template=add-paper.yml) |
| WACV | conference | Vision | **4** | [➕](../../issues/new?template=add-paper.yml) |
| ACM MM | conference | Vision | **5** | [➕](../../issues/new?template=add-paper.yml) |
| ACL | conference | Language | **37** | [➕](../../issues/new?template=add-paper.yml) |
| EMNLP | conference | Language | **12** | [➕](../../issues/new?template=add-paper.yml) |
| NAACL | conference | Language | — | [➕](../../issues/new?template=add-paper.yml) |
| COLING | conference | Language | **1** | [➕](../../issues/new?template=add-paper.yml) |
| TACL | journal | Language | — | [➕](../../issues/new?template=add-paper.yml) |
| Computational Linguistics | journal | Language | — | [➕](../../issues/new?template=add-paper.yml) |
| SIGIR | conference | Information retrieval | **17** | [➕](../../issues/new?template=add-paper.yml) |
| CIKM | conference | Information retrieval | — | [➕](../../issues/new?template=add-paper.yml) |
| KDD | conference | Information retrieval | **2** | [➕](../../issues/new?template=add-paper.yml) |
| RecSys | conference | Information retrieval | — | [➕](../../issues/new?template=add-paper.yml) |
| The Web Conference | conference | Information retrieval | — | [➕](../../issues/new?template=add-paper.yml) |
| ACM TOIS | journal | Information retrieval | **4** | [➕](../../issues/new?template=add-paper.yml) |
| IP&M | journal | Information retrieval | — | [➕](../../issues/new?template=add-paper.yml) |
| NeurIPS | conference | Machine learning | **15** | [➕](../../issues/new?template=add-paper.yml) |
| ICLR | conference | Machine learning | **16** | [➕](../../issues/new?template=add-paper.yml) |
| AAAI | conference | Machine learning | **10** | [➕](../../issues/new?template=add-paper.yml) |
| IJCAI | conference | Machine learning | — | [➕](../../issues/new?template=add-paper.yml) |
| JMLR | journal | Machine learning | — | [➕](../../issues/new?template=add-paper.yml) |
| AIJ | journal | Machine learning | — | [➕](../../issues/new?template=add-paper.yml) |
| ICDAR | conference | Document analysis | **21** | [➕](../../issues/new?template=add-paper.yml) |
| DAS | conference | Document analysis | **3** | [➕](../../issues/new?template=add-paper.yml) |
| IJDAR | journal | Document analysis | **7** | [➕](../../issues/new?template=add-paper.yml) |
| IEEE TPAMI | journal | Vision journals | — | [➕](../../issues/new?template=add-paper.yml) |
| IJCV | journal | Vision journals | — | [➕](../../issues/new?template=add-paper.yml) |
| IEEE TIP | journal | Vision journals | — | [➕](../../issues/new?template=add-paper.yml) |
| IEEE TMM | journal | Vision journals | — | [➕](../../issues/new?template=add-paper.yml) |
| CVIU | journal | Vision journals | **1** | [➕](../../issues/new?template=add-paper.yml) |
| Pattern Recognition | journal | Vision journals | **5** | [➕](../../issues/new?template=add-paper.yml) |
| IEEE TNNLS | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| Neural Networks | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| KBS | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| Information Sciences | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| ACM TIST | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| ESWA | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| IEEE Access | journal | Applied and general | — | [➕](../../issues/new?template=add-paper.yml) |
| Other venues | mixed | — | 31 | [➕](../../issues/new?template=add-paper.yml) |
